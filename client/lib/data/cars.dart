...
const List<GameCard> cars = [
  ...
  GameCard(
      ...
      3.8,
      325000),
  GameCard(26, 'Jaguar E-Type', '1961', 'Jaguar_E-Type.jpg', 'AlfvanBeem, CC0, via Wikimedia Commons',
      '', 198, 241, 1315, 6.9, 48800),
  GameCard(
      27,
      'Volkswagen T6',
      '2015',
  ...
  GameCard(29, 'Corvette C7 Stingray', '2013', 'corvette.webp', 'pixabay',
      'https://pixabay.com/service/license/', 343, 290, 1540, 4.2, 69990),
  GameCard(
      30,
  ...
  GameCard(31, 'Ford Model T', '1908', 'Ford_Model_T.jpg', "Iwaov / CC BY 2.0",
      "https://creativecommons.org/licenses/by/2.0", 15, 72, 540, 99, 23480),
  GameCard(
      32,
      'Volkswagen Beetle',
      '1938',
...
GameCard(
  ...
  '1966',
  'Ferrari_330_P3.jpg',
  'asopuma from Paris, France, CC BY 2.0, via Wikimedia Commons',
  'https://creativecommons.org/licenses/by/2.0',
  309,
  310,
  851,
...
GameCard(
  ...
  '1962',
  'Peel_P50.jpg',
  'Kieran White, CC BY 2.0, via Wikimedia Commons',
  'https://creativecommons.org/licenses/by/2.0',
  2.5,
  45,
  59,
...
GameCard(
  ...
  'Marvin Raaijmakers, CC BY-SA 2.5, via Wikimedia Commons',
  'https://creativecommons.org/licenses/by-sa/2.5',
  147,
  220,
  1270,
...
GameCard(
  ...
  'Lamborghini Miura',
  '1966',
  'Lamborghini_Miura.jpg',
  'Eric Manesse, CC BY-SA 4.0, via Wikimedia Commons',
  'https://creativecommons.org/licenses/by-sa/4.0',
  257,
  276,
  1180,
...
GameCard(
  ...
  '1992',
  'McLaren_F1.jpg',
  'Simon Davison, CC BY 2.0, via Wikimedia Commons',
  'https://creativecommons.org/licenses/by/2.0',
  627,
  370,
  1138,
...
GameCard(
  ...
  '2013',
  'Skoda_Octavia.jpg',
  'Kahvilokki, CC0, via Wikimedia Commons',
  '',
  162,
  248,
  1430,
...
GameCard(
  ...
  '1969',
  'Datsun_240Z.jpg',
  'An unusual eye, Public domain, via Wikimedia Commons',
  '',
  112,
  201,
  1042,
  ...
  '1973',
  'Pontiac_Firebird.jpg',
  'Elmschrat Coaching38, CC BY-SA 3.0, via Wikimedia Commons',
  'https://creativecommons.org/licenses/by-sa/3.0',
  231,
  185,
  1691,
  ...
  '2021',
  'McMurtry_Speirling.jpg',
  'Michele Borioli, CC BY 2.0, via Wikimedia Commons',
  'https://creativecommons.org/licenses/by/2.0',
  745,
  298,
  980,
